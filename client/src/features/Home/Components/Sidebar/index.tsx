...
const Sidebar = () => {
    ...
    const items = useMemo<MenuItem[]>(() => {
        return [
            getItem(
                <Link to="/hot" className={styles.section}>
                    Hot
                </Link>,
                'hot',
                <HomeFilled />,
            ...
            getItem(
                <Link to="/trending" className={styles.section}>
                    Trending
                </Link>,
                'trending',
                <RiseOutlined />,
            ...
            getItem(
                <Link to="/fresh" className={styles.section}>
                    Fresh
                </Link>,
                'fresh',
                <ClockCircleOutlined />,
            ...
            getItem(
                <Link to="/top" className={styles.section}>
                    Top
                </Link>,
                'top',
                <BarChartOutlined />,
    ...
    const items2 = useMemo<MenuItem[]>(() => {
        return sections.map((section, index) =>
            getItem(
                <Link
                    to={`/tag/${section.name.toLowerCase()}`}
