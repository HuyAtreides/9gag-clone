...
/**
 * From https://gist.github.com/evolkmann/740d24889c509c08484a8ff72af5dd64. Country Codes ISO 3166
 */
public enum Country {
    AF("Afghanistan"),
    AX("Aland Islands"),
     ...
     */
    static public Country toCountry(String value) throws ValueToEnumException {
        return Arrays.stream(Country.values()).filter(c -> c.getValue().equals(value)).findFirst()
                .orElseThrow(() -> new ValueToEnumException("Country doesn't exist."));
    }
